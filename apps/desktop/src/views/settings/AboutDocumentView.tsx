      ...
      <PaneHeader
        ...
        leading={
          <button
            ...
            className="-ml-1 inline-flex h-7 shrink-0 items-center rounded-control px-1 text-label-secondary transition-colors duration-(--duration-fast) ease-out hover:bg-surface-hover hover:text-label"
          >
