...
fn legacy_source_format(value: &str) -> Option<SourceFormat> {
    Some(match value {
        ...
        "ClineMessagesContractV1" => SourceFormat::ClineMessagesContractV1,
        "KiroSessionJson" => SourceFormat::KiroSessionJson,
        "KiroChat" => SourceFormat::KiroChat,
        "KiroCliV2Bundle" => SourceFormat::KiroCliV2Bundle,
        "KiroCliV3Bundle" => SourceFormat::KiroCliV3Bundle,
        "KiroChatSaveExport" => SourceFormat::KiroChatSaveExport,
