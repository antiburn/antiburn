...
/// v50 widens the factor sample and point lanes to admit a model-scoped
...
const V50: &str = r#"
CREATE TABLE provider_limit_factor_sample_v50 (
    id                  INTEGER PRIMARY KEY,
    provider            TEXT NOT NULL,
    account_key         TEXT NOT NULL,
...
INSERT INTO provider_limit_factor_sample_v50 (
...
ALTER TABLE provider_limit_factor_sample_v50 RENAME TO provider_limit_factor_sample;
...
CREATE TABLE provider_limit_factor_point_v50 (
    id                  INTEGER PRIMARY KEY,
    provider            TEXT NOT NULL,
    account_key         TEXT NOT NULL,
    lane                TEXT NOT NULL CHECK (lane IN ('weekly', 'fiveHour') OR lane LIKE 'model:%'),
...
INSERT INTO provider_limit_factor_point_v50 (
...
ALTER TABLE provider_limit_factor_point_v50 RENAME TO provider_limit_factor_point;
