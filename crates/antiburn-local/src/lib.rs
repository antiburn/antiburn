...
//! antiburn-local: the canonical, network-free local engine behind antiburn.
//!
...
//!
//! - **No network or socket I/O.** Discovery reads documented files,
//!   read-only databases, and bounded WSL paths only.
