...
| `antiburn.burn_check_outcome_observed`   | A Passed target/cycle pair is visible in an active, unsnoozed Burn Checks row, either in the summary or in a deliberately expanded target list. Background verification, hidden rows, snoozed checks, and non-Passed results emit nothing.                                                                                                                                                                                                                                                                                                                                                                         | `detail` — `verified` means the visible Passed transition; `recurred` means a visible regression. `origin` — `passive` or `action`, which describes how the watch started and does not claim causation. No finding, action, watch, cycle, reference, sample, or evidence revision; no exact tokens or costs.                                                                                                                                                                      |
