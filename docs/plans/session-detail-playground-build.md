...
- The $/MTok reading prints its guidance inline under the scale on the Cost tab (what it measures, the profile thresholds, what to change) instead of a tooltip, so the tab no longer ends in a gap. The composition rows keep their tooltips (2026-09-04).
