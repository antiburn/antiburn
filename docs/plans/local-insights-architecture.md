...
- **Date:** 2026-08-20
- **Verified against:** `origin/main` @ `8d83005` (the PR #117 merge, which shipped CH-001) — line numbers may drift; **prefer symbol/function names** over line numbers.
...
Verified against `origin/main` @ `8d83005`. `crates/antiburn-local` is the only crate under `crates/`.
