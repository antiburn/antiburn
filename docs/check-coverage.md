...
When no exact prompt target is available, the check-level Copy action can return
a bounded generic fallback for a check that still has findings.
...
| `KiroCliV2Bundle`              | No             | No                 | No remediation prompt                       |
| `KiroCliV3Bundle`              | No             | No                 | No remediation prompt                       |
| `KiroChatSaveExport`           | No             | No                 | No remediation prompt                       |
